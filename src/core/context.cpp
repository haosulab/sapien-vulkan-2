...
std::shared_ptr<Context> Context::Create(bool present, uint32_t maxNumMaterials,
  ...
  auto context = std::make_shared<Context>(present, maxNumMaterials, maxNumTextures,
...
Context::Context(bool present, uint32_t maxNumMaterials, uint32_t maxNumTextures,
  ...
  // descriptor pool for materials & textures
  ...
  mMetallicDescriptorSetLayout =
      getDevice().createDescriptorSetLayoutUnique(vk::DescriptorSetLayoutCreateInfo({}, bindings));
