...
class GLSLCompiler {
public:
  static std::vector<std::uint32_t> const &compileGlslFileCached(vk::ShaderStageFlagBits stage,
  ...
  compileToSpirv(vk::ShaderStageFlagBits shaderStage, std::string const &glslCode,
