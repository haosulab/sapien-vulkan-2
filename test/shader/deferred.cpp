...
TEST(Deferred, Minimal) {
    ...
    auto specializationConstantLayout = deferred.getSpecializationConstantLayout();
    ASSERT_TRUE(CONTAINS(specializationConstantLayout->elements, "NUM_DIRECTIONAL_LIGHTS"));
    ASSERT_TRUE(CONTAINS(specializationConstantLayout->elements, "NUM_POINT_LIGHTS"));

    ASSERT_EQ(specializationConstantLayout->elements["NUM_DIRECTIONAL_LIGHTS"].dtype, eINT);
    ASSERT_EQ(specializationConstantLayout->elements["NUM_POINT_LIGHTS"].dtype, eINT);
    ...
    ASSERT_TRUE(CONTAINS(sceneLayout->elements["directionalLights"].member->elements, "direction"));
    ASSERT_TRUE(CONTAINS(sceneLayout->elements["directionalLights"].member->elements, "emission"));
    ASSERT_TRUE(CONTAINS(sceneLayout->elements["pointLights"].member->elements, "position"));
    ASSERT_TRUE(CONTAINS(sceneLayout->elements["pointLights"].member->elements, "emission"));
    ...
    ASSERT_EQ(sceneLayout->elements["directionalLights"].member->elements.size(), 2);
    ASSERT_EQ(sceneLayout->elements["directionalLights"].member->elements["direction"].offset, 0);
    ASSERT_EQ(sceneLayout->elements["directionalLights"].member->elements["direction"].dtype, eFLOAT4);
    ASSERT_EQ(sceneLayout->elements["directionalLights"].member->elements["emission"].offset, 16);
    ASSERT_EQ(sceneLayout->elements["directionalLights"].member->elements["emission"].dtype, eFLOAT4);
    ...
    ASSERT_EQ(sceneLayout->elements["pointLights"].member->elements["position"].offset, 0);
    ASSERT_EQ(sceneLayout->elements["pointLights"].member->elements["position"].dtype, eFLOAT4);
    ASSERT_EQ(sceneLayout->elements["pointLights"].member->elements["emission"].offset, 16);
    ASSERT_EQ(sceneLayout->elements["pointLights"].member->elements["emission"].dtype, eFLOAT4);
